defmodule Uaddresses.Web.SettlementControllerTest do
  ...
  test "does not create settlement and renders errors when data without settlement field", %{
    conn: conn
  } do
  ...
  test "search", %{conn: conn} do
    ...
    conn = get(conn, "/settlements/?region=київська&name=воло")
